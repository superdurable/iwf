...
This [Subscription workflow](https://github.com/superdurable/iwf-golang-samples/tree/main/workflows/subscription) (with unit tests) is to match the use case described in
